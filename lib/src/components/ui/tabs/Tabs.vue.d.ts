...
}, string, import('vue').PublicProps, Readonly<globalThis.ExtractPropTypes<__VLS_TypePropsToRuntimeProps<TabsRootProps<import('radix-vue/dist/shared/types').StringOrNumber>>>> & {
